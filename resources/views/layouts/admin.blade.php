            ...
            <div class="nav_menu">
                ...
                <ul class=" navbar-right">
                  <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <a href="javascript:;" class="user-profile dropdown-toggle" role="button" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
