									...
									@method('put')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" name="name" class="form-control" value={{$user->name}}>
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" class="flat" name="published" @checked($user->published)>
												</label>
											</div>
										</div>
										<div class="item form-group">
